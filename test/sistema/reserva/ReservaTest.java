...
public class ReservaTest {
	...
	@Test
	public void testSePuedeCancelarUnaReservaYaAceptada() throws AlquilerNoDisponibleException, FormaDePagoNoAceptadaException, ReservaNoCancelableException {
	...
	@Test
	public void testSePuedeFinalizarUnaReserva() throws AlquilerNoDisponibleException, FormaDePagoNoAceptadaException, ReservaNoCancelableException {
	...
	@Test
	public void testUnaVezFinalizadaNoSePuedeAceptarNiRechazar() throws AlquilerNoDisponibleException, FormaDePagoNoAceptadaException, ReservaNoCancelableException {
		this.re.aceptar(mock(NotificadorManager.class));
		this.re.finalizar();
		this.re.aceptar(mock(NotificadorManager.class));
		assertFalse(this.re.estaActiva());
	...
	@Test
	public void testCancelarCunadoNoSePuedeTiraExcepcion() throws AlquilerNoDisponibleException, FormaDePagoNoAceptadaException, ReservaNoCancelableException {
