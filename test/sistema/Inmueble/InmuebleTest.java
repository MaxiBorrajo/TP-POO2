...
public class InmuebleTest {
    ...
    public void testSonElMismoInmueble() {
    	...
    	assertFalse(this.inmueble.sonElMismoInmueble(new  Inmueble(120, mock(TipoDeInmueble.class), mock(Ubicacion.class),Arrays.asList(mock(Servicio.class)),5,propietario )));
    }
